...
public class ProtocolCommand implements Command {
    ...
    private int MAX_FILE_NAME_SIZE;
    private int MAX_FILE_SIZE_STRING;
    private int MAX_USERNAME_SIZE;
    private int MAX_PASSWORD_SIZE;
...
//  5  byte   for command 10 byte   for   username 10 byte  for  password
    ...
    protected byte[] authrCommand(String username, String psw) {
...
//        вариант с  ограничением  на   размер  файла  в   3  ГБ
    ...
    protected String newflCommandStr (String name) {
